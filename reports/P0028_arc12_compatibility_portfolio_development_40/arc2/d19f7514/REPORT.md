# ARC2 `d19f7514` P0028-ARC12-COMPATIBILITY-PORTFOLIO-DEVELOPMENT-40 Brain Surgery Report
...
- **Fallback used:** `False`
- **Selected hypothesis:** `adjacent_bilateral_cellwise_combine(axis=horizontal,table=0:0:0;0:5:4;3:0:4;3:5:4)`
...
- `1` `PROPOSE` — `{"parent_theory_id":"T0000","rule":{"description_length":8,"name":"adjacent_bilateral_cellwise_combine(axis=horizontal,table=0:0:0;0:5:4;3:0:4;3:5:4)","operation":"full_operator","parameters":{"axis":"horizontal","operator":"adjacent_bilateral_cellwise_combine","table":"0:0:0;0:5:4;3:0:4;3:5:4"},"rule_id":"rule-adjacent_bilateral_cellwise_combine","scope":{"kind":"all","value":null}},"stage":"initial_generic_theories","theory_id":"T0002"}`
