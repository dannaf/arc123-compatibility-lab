# ARC1 `feca6190` P0025-ARC12-HIDDEN-ZERO-STREAM-DEVELOPMENT-40 Brain Surgery Report
...
- **Fallback used:** `False`
- **Selected hypothesis:** `anti_diagonal_nonbackground_stream(background_color=0)`
...
- `1` `PROPOSE` — `{"parent_theory_id":"T0000","rule":{"description_length":7,"name":"anti_diagonal_nonbackground_stream(background_color=0)","operation":"full_operator","parameters":{"background_color":0,"operator":"anti_diagonal_nonbackground_stream"},"rule_id":"rule-anti_diagonal_nonbackground_stream","scope":{"kind":"all","value":null}},"stage":"initial_generic_theories","theory_id":"T0002"}`
...
- `110` `COMMIT` — `{"complete_prediction_group_count":1,"final_theory":{"contradiction_count":0,"counterexamples":[],"description_length":7,"evaluated_demo_indices":[0,1,2,3,4],"history":[{"kind":"ADD_RULE","parameters":{"initial_proposal":true,"operation":"full_operator"},"target":"rule-anti_diagonal_nonbackground_stream"},{"kind":"ATTEND","parameters":{"information_score":[225,0,4],"reason":"initial_highest_observed_change_and_color_discrimination"},"target":"demo:2"},{"kind":"ATTEND","parameters":{"information_score":[225,0,4],"reason":"unseen_demo_selected_for_residual_version_space_discrimination"},"target":"demo:3"},{"kind":"ATTEND","parameters":{"information_score":[100,0,3],"reason":"unseen_demo_selected_for_residual_version_space_discrimination"},"target":"demo:0"},{"kind":"ATTEND","parameters":{"information_score":[25,0,2],"reason":"unseen_demo_selected_for_residual_version_space_discrimination"},"target":"demo:1"},{"kind":"ATTEND","parameters":{"information_score":[25,0,2],"reason":"unseen_demo_selected_for_residual_version_space_discrimination"},"target":"demo:4"}],"matching_cell_count":600,"name":"anti_diagonal_nonbackground_stream(background_color=0)","parameter_bindings":{},"parent_theory_id":"T0000","rules":[{"description_length":7,"name":"anti_diagonal_nonbackground_stream(background_color=0)","operation":"full_operator","parameters":{"background_color":0,"operator":"anti_diagonal_nonbackground_stream"},"rule_id":"rule-anti_diagonal_nonbackground_stream","scope":{"kind":"all","value":null}}],"scope_predicates":[{"kind":"all","value":null}],"theory_id":"T0002","unknown_cell_count":0,"unresolved_unknown":[]},"posterior_mass":1.0,"selected_hypothesis":"anti_diagonal_nonbackground_stream(background_color=0)","theory_id":"T0002","training_exact":true}`
