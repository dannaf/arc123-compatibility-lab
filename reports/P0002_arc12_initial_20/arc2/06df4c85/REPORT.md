# ARC2 `06df4c85` IHL Brain Surgery Report
...
- `0` `ATTEND` — `{"demo_change_counts":[{"changed_cells":36,"demo_index":0},{"changed_cells":36,"demo_index":2},{"changed_cells":20,"demo_index":1}],"evidence_world_count":3,"selected_demo":0}`
- `1` `PROPOSE` — `{"generic_candidate_count":2028,"locally_ranked_candidate_count":32,"stage":"global_generic_relations"}`
...
- `131` `PROPOSE` — `{"generic_candidate_count":140,"locally_ranked_candidate_count":32,"stage":"residual_directed_generic_relations"}`
...
- `4` — `{"counterexample":{"column":3,"demo_index":0,"observed":2,"predicted":0,"row":6},"hypothesis":"identity","stage":"global_generic_relations"}`
- `8` — `{"counterexample":{"column":3,"demo_index":0,"observed":2,"predicted":0,"row":3},"hypothesis":"mirror(axis=left_right)","stage":"global_generic_relations"}`
- `12` — `{"counterexample":{"column":3,"demo_index":0,"observed":2,"predicted":8,"row":3},"hypothesis":"mirror(axis=rotate_180)","stage":"global_generic_relations"}`
- `16` — `{"counterexample":{"column":3,"demo_index":0,"observed":2,"predicted":0,"row":3},"hypothesis":"mirror(axis=top_bottom)","stage":"global_generic_relations"}`
- `20` — `{"counterexample":{"column":0,"demo_index":0,"observed":0,"predicted":1,"row":0},"hypothesis":"translate(column_offset=3,row_offset=0)","stage":"global_generic_relations"}`
