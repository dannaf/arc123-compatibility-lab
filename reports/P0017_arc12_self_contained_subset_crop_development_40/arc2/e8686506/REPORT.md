# ARC2 `e8686506` P0017-ARC12-SELF-CONTAINED-SUBSET-CROP-DEVELOPMENT-40 Brain Surgery Report
...
```json
[[1, 8, 8, 8, 1], [8, 6, 6, 6, 8], [3, 8, 6, 8, 3], [3, 8, 9, 8, 3], [3, 8, 9, 8, 3], [3, 8, 6, 8, 3], [8, 6, 6, 6, 8], [1, 8, 8, 8, 1]]
```
