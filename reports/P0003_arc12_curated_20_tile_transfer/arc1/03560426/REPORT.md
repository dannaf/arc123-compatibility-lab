...
- `0` `ATTEND` — `{"demo_change_counts":[{"changed_cells":42,"demo_index":1},{"changed_cells":39,"demo_index":2},{"changed_cells":33,"demo_index":0}],"evidence_world_count":3,"selected_demo":1}`
...
- `4` — `{"counterexample":{"column":0,"demo_index":0,"observed":1,"predicted":0,"row":0},"hypothesis":"translate(column_offset=9,row_offset=9)","stage":"global_generic_relations"}`
- `8` — `{"counterexample":{"column":0,"demo_index":0,"observed":1,"predicted":0,"row":0},"hypothesis":"translate(column_offset=9,row_offset=8)","stage":"global_generic_relations"}`
- `12` — `{"counterexample":{"column":0,"demo_index":0,"observed":1,"predicted":0,"row":0},"hypothesis":"translate(column_offset=9,row_offset=7)","stage":"global_generic_relations"}`
- `16` — `{"counterexample":{"column":0,"demo_index":0,"observed":1,"predicted":0,"row":0},"hypothesis":"translate(column_offset=9,row_offset=6)","stage":"global_generic_relations"}`
- `20` — `{"counterexample":{"column":0,"demo_index":0,"observed":1,"predicted":0,"row":0},"hypothesis":"translate(column_offset=9,row_offset=5)","stage":"global_generic_relations"}`
