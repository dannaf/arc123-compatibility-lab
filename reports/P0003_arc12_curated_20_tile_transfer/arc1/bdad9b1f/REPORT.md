...
- `0` `ATTEND` — `{"demo_change_counts":[{"changed_cells":7,"demo_index":0},{"changed_cells":7,"demo_index":1}],"evidence_world_count":2,"selected_demo":0}`
- `1` `PROPOSE` — `{"generic_candidate_count":124,"locally_ranked_candidate_count":32,"stage":"global_generic_relations"}`
...
- `4` — `{"counterexample":{"column":2,"demo_index":0,"observed":2,"predicted":0,"row":2},"hypothesis":"identity","stage":"global_generic_relations"}`
- `8` — `{"counterexample":{"column":4,"demo_index":0,"observed":8,"predicted":0,"row":0},"hypothesis":"translate(column_offset=2,row_offset=0)","stage":"global_generic_relations"}`
- `12` — `{"counterexample":{"column":4,"demo_index":0,"observed":8,"predicted":0,"row":0},"hypothesis":"translate(column_offset=0,row_offset=4)","stage":"global_generic_relations"}`
- `16` — `{"counterexample":{"column":4,"demo_index":0,"observed":8,"predicted":0,"row":0},"hypothesis":"translate(column_offset=5,row_offset=0)","stage":"global_generic_relations"}`
- `20` — `{"counterexample":{"column":4,"demo_index":0,"observed":8,"predicted":0,"row":0},"hypothesis":"translate(column_offset=4,row_offset=0)","stage":"global_generic_relations"}`
