# ARC1 `a5313dff` IHL Brain Surgery Report
...
- `0` `ATTEND` — `{"demo_change_counts":[{"changed_cells":22,"demo_index":2},{"changed_cells":8,"demo_index":0},{"changed_cells":8,"demo_index":1}],"evidence_world_count":3,"selected_demo":2}`
- `1` `PROPOSE` — `{"generic_candidate_count":532,"locally_ranked_candidate_count":32,"stage":"global_generic_relations"}`
...
- `4` — `{"counterexample":{"column":2,"demo_index":0,"observed":1,"predicted":0,"row":2},"hypothesis":"identity","stage":"global_generic_relations"}`
- `8` — `{"counterexample":{"column":1,"demo_index":0,"observed":0,"predicted":2,"row":0},"hypothesis":"translate(column_offset=0,row_offset=-2)","stage":"global_generic_relations"}`
- `12` — `{"counterexample":{"column":0,"demo_index":0,"observed":0,"predicted":2,"row":1},"hypothesis":"translate(column_offset=-2,row_offset=0)","stage":"global_generic_relations"}`
- `16` — `{"counterexample":{"column":1,"demo_index":0,"observed":2,"predicted":0,"row":1},"hypothesis":"mirror(axis=top_bottom)","stage":"global_generic_relations"}`
- `20` — `{"counterexample":{"column":1,"demo_index":0,"observed":2,"predicted":0,"row":1},"hypothesis":"mirror(axis=left_right)","stage":"global_generic_relations"}`
