...
- `0` `ATTEND` — `{"demo_change_counts":[{"changed_cells":18,"demo_index":0},{"changed_cells":18,"demo_index":1},{"changed_cells":18,"demo_index":2}],"evidence_world_count":3,"selected_demo":0}`
...
- `7` — `{"counterexample":{"column":0,"demo_index":0,"observed":0,"predicted":1,"row":3},"hypothesis":"tile_repeat(column_factor=1,row_factor=2)","stage":"global_generic_relations"}`
