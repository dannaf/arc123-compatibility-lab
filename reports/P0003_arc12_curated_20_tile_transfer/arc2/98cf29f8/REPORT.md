...
- `0` `ATTEND` — `{"demo_change_counts":[{"changed_cells":60,"demo_index":2},{"changed_cells":22,"demo_index":1},{"changed_cells":15,"demo_index":0}],"evidence_world_count":3,"selected_demo":2}`
- `1` `PROPOSE` — `{"generic_candidate_count":1224,"locally_ranked_candidate_count":32,"stage":"global_generic_relations"}`
...
- `4` — `{"counterexample":{"column":1,"demo_index":0,"observed":0,"predicted":4,"row":5},"hypothesis":"identity","stage":"global_generic_relations"}`
- `8` — `{"counterexample":{"column":1,"demo_index":0,"observed":0,"predicted":4,"row":5},"hypothesis":"mirror(axis=top_bottom)","stage":"global_generic_relations"}`
- `12` — `{"counterexample":{"column":7,"demo_index":0,"observed":2,"predicted":0,"row":3},"hypothesis":"translate(column_offset=1,row_offset=0)","stage":"global_generic_relations"}`
- `16` — `{"counterexample":{"column":6,"demo_index":0,"observed":0,"predicted":2,"row":3},"hypothesis":"translate(column_offset=-1,row_offset=0)","stage":"global_generic_relations"}`
- `20` — `{"counterexample":{"column":7,"demo_index":0,"observed":2,"predicted":0,"row":3},"hypothesis":"translate(column_offset=0,row_offset=1)","stage":"global_generic_relations"}`
