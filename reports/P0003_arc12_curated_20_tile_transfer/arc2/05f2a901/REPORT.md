...
- `0` `ATTEND` — `{"demo_change_counts":[{"changed_cells":20,"demo_index":2},{"changed_cells":18,"demo_index":0},{"changed_cells":12,"demo_index":1}],"evidence_world_count":3,"selected_demo":2}`
- `1` `PROPOSE` — `{"generic_candidate_count":516,"locally_ranked_candidate_count":32,"stage":"global_generic_relations"}`
...
- `4` — `{"counterexample":{"column":6,"demo_index":0,"observed":8,"predicted":0,"row":4},"hypothesis":"translate(column_offset=3,row_offset=0)","stage":"global_generic_relations"}`
- `8` — `{"counterexample":{"column":4,"demo_index":0,"observed":2,"predicted":0,"row":1},"hypothesis":"translate(column_offset=4,row_offset=0)","stage":"global_generic_relations"}`
- `12` — `{"counterexample":{"column":4,"demo_index":0,"observed":2,"predicted":0,"row":1},"hypothesis":"translate(column_offset=4,row_offset=1)","stage":"global_generic_relations"}`
- `16` — `{"counterexample":{"column":4,"demo_index":0,"observed":2,"predicted":0,"row":1},"hypothesis":"translate(column_offset=3,row_offset=1)","stage":"global_generic_relations"}`
- `20` — `{"counterexample":{"column":4,"demo_index":0,"observed":0,"predicted":2,"row":0},"hypothesis":"translate(column_offset=3,row_offset=-1)","stage":"global_generic_relations"}`
