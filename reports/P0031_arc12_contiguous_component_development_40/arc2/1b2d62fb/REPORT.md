# ARC2 `1b2d62fb` P0031-ARC12-CONTIGUOUS-COMPONENT-DEVELOPMENT-40 Brain Surgery Report
...
- **Fallback used:** `False`
- **Selected hypothesis:** `central_separator_cellwise_combine(axis=vertical,table=0:0:8;0:9:0;9:0:0;9:9:0)`
...
- `1` `PROPOSE` — `{"parent_theory_id":"T0000","rule":{"description_length":8,"name":"central_separator_cellwise_combine(axis=vertical,table=0:0:8;0:9:0;9:0:0;9:9:0)","operation":"full_operator","parameters":{"axis":"vertical","operator":"central_separator_cellwise_combine","table":"0:0:8;0:9:0;9:0:0;9:9:0"},"rule_id":"rule-central_separator_cellwise_combine","scope":{"kind":"all","value":null}},"stage":"initial_generic_theories","theory_id":"T0002"}`
