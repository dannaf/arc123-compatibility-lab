...
- `0` `ATTEND` — `{"demo_change_counts":[{"changed_cells":4,"demo_index":0},{"changed_cells":3,"demo_index":1},{"changed_cells":3,"demo_index":2}],"evidence_world_count":3,"selected_demo":0}`
...
- `115` `PROPOSE` — `{"generic_candidate_count":210,"locally_ranked_candidate_count":32,"stage":"residual_directed_generic_relations"}`
...
- `8` — `{"counterexample":{"column":1,"demo_index":0,"observed":2,"predicted":0,"row":0},"hypothesis":"mirror(axis=top_bottom)","stage":"global_generic_relations"}`
...
- `16` — `{"counterexample":{"column":1,"demo_index":0,"observed":2,"predicted":0,"row":0},"hypothesis":"mirror(axis=rotate_180)","stage":"global_generic_relations"}`
- `20` — `{"counterexample":{"column":0,"demo_index":0,"observed":7,"predicted":8,"row":1},"hypothesis":"mirror(axis=left_right)","stage":"global_generic_relations"}`
