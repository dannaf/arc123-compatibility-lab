# ARC2 `80af3007` P0024-ARC12-PANEL-STREAM-FRACTAL-DEVELOPMENT-40 Brain Surgery Report
...
- **Fallback used:** `False`
- **Selected hypothesis:** `uniform_block_self_stamp_fractal`
...
- `1` `PROPOSE` — `{"parent_theory_id":"T0000","rule":{"description_length":7,"name":"uniform_block_self_stamp_fractal","operation":"full_operator","parameters":{"operator":"uniform_block_self_stamp_fractal"},"rule_id":"rule-uniform_block_self_stamp_fractal","scope":{"kind":"all","value":null}},"stage":"initial_generic_theories","theory_id":"T0002"}`
...
- `70` `COMMIT` — `{"complete_prediction_group_count":1,"final_theory":{"contradiction_count":0,"counterexamples":[],"description_length":7,"evaluated_demo_indices":[0,1,2],"history":[{"kind":"ADD_RULE","parameters":{"initial_proposal":true,"operation":"full_operator"},"target":"rule-uniform_block_self_stamp_fractal"},{"kind":"ATTEND","parameters":{"information_score":[81,0,2],"reason":"initial_highest_observed_change_and_color_discrimination"},"target":"demo:0"},{"kind":"ATTEND","parameters":{"information_score":[81,0,2],"reason":"unseen_demo_selected_for_residual_version_space_discrimination"},"target":"demo:1"},{"kind":"ATTEND","parameters":{"information_score":[81,0,2],"reason":"unseen_demo_selected_for_residual_version_space_discrimination"},"target":"demo:2"}],"matching_cell_count":243,"name":"uniform_block_self_stamp_fractal","parameter_bindings":{},"parent_theory_id":"T0000","rules":[{"description_length":7,"name":"uniform_block_self_stamp_fractal","operation":"full_operator","parameters":{"operator":"uniform_block_self_stamp_fractal"},"rule_id":"rule-uniform_block_self_stamp_fractal","scope":{"kind":"all","value":null}}],"scope_predicates":[{"kind":"all","value":null}],"theory_id":"T0002","unknown_cell_count":0,"unresolved_unknown":[]},"posterior_mass":1.0,"selected_hypothesis":"uniform_block_self_stamp_fractal","theory_id":"T0002","training_exact":true}`
