# ARC1 `dae9d2b5` P0040-ARC12-UNIFORM-FRAME-SIZE-FILL-DEVELOPMENT-40 Brain Surgery Report
...
- **Fallback used:** `False`
- **Selected hypothesis:** `adjacent_bilateral_cellwise_combine(axis=vertical,table=0:0:0;0:3:6;4:0:6;4:3:6)`
...
- `1` `PROPOSE` — `{"parent_theory_id":"T0000","rule":{"description_length":8,"name":"adjacent_bilateral_cellwise_combine(axis=vertical,table=0:0:0;0:3:6;4:0:6;4:3:6)","operation":"full_operator","parameters":{"axis":"vertical","operator":"adjacent_bilateral_cellwise_combine","table":"0:0:0;0:3:6;4:0:6;4:3:6"},"rule_id":"rule-adjacent_bilateral_cellwise_combine","scope":{"kind":"all","value":null}},"stage":"initial_generic_theories","theory_id":"T0002"}`
...
- `115` `COMMIT` — `{"complete_prediction_group_count":1,"final_theory":{"contradiction_count":0,"counterexamples":[],"description_length":8,"evaluated_demo_indices":[0,1,2,3,4],"history":[{"kind":"ADD_RULE","parameters":{"initial_proposal":true,"operation":"full_operator"},"target":"rule-adjacent_bilateral_cellwise_combine"},{"kind":"ATTEND","parameters":{"information_score":[9,3,4],"reason":"initial_highest_observed_change_and_color_discrimination"},"target":"demo:0"},{"kind":"ATTEND","parameters":{"information_score":[9,3,4],"reason":"unseen_demo_selected_for_residual_version_space_discrimination"},"target":"demo:1"},{"kind":"ATTEND","parameters":{"information_score":[9,3,4],"reason":"unseen_demo_selected_for_residual_version_space_discrimination"},"target":"demo:2"},{"kind":"ATTEND","parameters":{"information_score":[9,3,4],"reason":"unseen_demo_selected_for_residual_version_space_discrimination"},"target":"demo:3"},{"kind":"ATTEND","parameters":{"information_score":[9,3,4],"reason":"unseen_demo_selected_for_residual_version_space_discrimination"},"target":"demo:4"}],"matching_cell_count":45,"name":"adjacent_bilateral_cellwise_combine(axis=vertical,table=0:0:0;0:3:6;4:0:6;4:3:6)","parameter_bindings":{},"parent_theory_id":"T0000","rules":[{"description_length":8,"name":"adjacent_bilateral_cellwise_combine(axis=vertical,table=0:0:0;0:3:6;4:0:6;4:3:6)","operation":"full_operator","parameters":{"axis":"vertical","operator":"adjacent_bilateral_cellwise_combine","table":"0:0:0;0:3:6;4:0:6;4:3:6"},"rule_id":"rule-adjacent_bilateral_cellwise_combine","scope":{"kind":"all","value":null}}],"scope_predicates":[{"kind":"all","value":null}],"theory_id":"T0002","unknown_cell_count":0,"unresolved_unknown":[]},"posterior_mass":1.0,"selected_hypothesis":"adjacent_bilateral_cellwise_combine(axis=vertical,table=0:0:0;0:3:6;4:0:6;4:3:6)","theory_id":"T0002","training_exact":true}`
