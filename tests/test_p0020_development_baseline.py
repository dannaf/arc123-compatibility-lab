...
PACKET_PATH = REPOSITORY_ROOT / "research" / "packets" / "P0020_ARC12_DEVELOPMENT_BASELINE_40.json"
REPORT_ROOT = REPOSITORY_ROOT / "reports" / "P0020_arc12_development_baseline_40"
EXPECTED_SOLVES = {
    ("arc1", "6430c8c4"),
    ("arc1", "0c9aba6e"),
    ("arc1", "3af2c5a8"),
...
class P0020DevelopmentBaselineTests(unittest.TestCase):
    ...
    def test_p0020_baseline_is_complete_and_retains_cross_cohort_geometry_results(self) -> None:
        ...
        self.assertTrue(
            all(
                "central_separator_cellwise_combine(axis=horizontal" in selected[key]
                for key in EXPECTED_SEPARATOR_SOLVES
            )
        )
        self.assertIn("dihedral_tile", selected[("arc1", "3af2c5a8")])
