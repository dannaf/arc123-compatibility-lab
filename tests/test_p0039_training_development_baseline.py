...
P0038_REPORT_ROOT = REPOSITORY_ROOT / "reports" / "P0038_arc12_cross_separator_reflection_training_transfer_50"
REPORT_ROOT = REPOSITORY_ROOT / "reports" / "P0039_arc12_training_development_baseline_40"
EXPECTED_SOLVES = {
    ("arc1", "74dd1130"),
    ("arc1", "dae9d2b5"),
    ("arc1", "ac0a08a4"),
...
class P0039TrainingDevelopmentBaselineTests(unittest.TestCase):
    ...
    def test_p0039_retains_complete_development_baseline_artifacts(self) -> None:
        packet = json.loads(PACKET_PATH.read_text(encoding="utf-8"))
        p0038_packet = json.loads(P0038_PACKET_PATH.read_text(encoding="utf-8"))
        summary = json.loads((REPORT_ROOT / "receipt.json").read_text(encoding="utf-8"))
        p0038_summary = json.loads((P0038_REPORT_ROOT / "receipt.json").read_text(encoding="utf-8"))
        ...
        self.assertEqual(summary["exact_solve_count_by_benchmark"], {"arc1": 3, "arc2": 0})
        ...
        self.assertEqual(packet["prior_transfer_reference"]["exact_solve_count"], 1)
        self.assertEqual(p0038_summary["exact_solve_count"], 1)
        self.assertEqual(p0038_summary["attempt_count"], 50)
