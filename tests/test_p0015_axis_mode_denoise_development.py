...
PACKET_PATH = REPOSITORY_ROOT / "research" / "packets" / "P0015_ARC12_AXIS_MODE_DENOISE_DEVELOPMENT_40.json"
REPORT_ROOT = REPOSITORY_ROOT / "reports" / "P0015_arc12_axis_mode_denoise_development_40"
BASELINE_REPORT_ROOT = REPOSITORY_ROOT / "reports" / "P0014_arc12_development_baseline_40"

sys.path.insert(0, str(REPOSITORY_ROOT / "scripts"))
import run_arc12_filename_holdout as packet_runner


class P0015AxisModeDenoiseDevelopmentTests(unittest.TestCase):
    ...
    def test_p0015_is_complete_reproducible_and_has_zero_baseline_delta(self) -> None:
        ...
        self.assertIn("axis_mode_denoise", packet["frozen_controller"]["generic_operator_families"])
        self.assertIn("Exact post-answer solves: `2/40`", readme)
        self.assertFalse(any("axis_mode_denoise" in entry["selected_hypothesis"] for entry in summary["attempts"]))
