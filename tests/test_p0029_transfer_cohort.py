...
COHORT_PATH = REPOSITORY_ROOT / "research" / "cohorts" / "ARC12_FILENAME_HOLDOUT_004.json"


class P0029TransferCohortTests(unittest.TestCase):
    def test_p0029_is_disjoint_all_training_filename_only_cohort(self) -> None:
        cohort = json.loads(COHORT_PATH.read_text(encoding="utf-8"))
        frozen = cohort["frozen_filename_only_50_p0029"]
        import_paths = tuple(
