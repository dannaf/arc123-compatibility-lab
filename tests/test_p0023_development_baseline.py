...
PACKET_PATH = REPOSITORY_ROOT / "research" / "packets" / "P0023_ARC12_DEVELOPMENT_BASELINE_40.json"
REPORT_ROOT = REPOSITORY_ROOT / "reports" / "P0023_arc12_development_baseline_40"
EXPECTED_SOLVES = {
    ("arc1", "c8f0f002"),
    ("arc1", "c3e719e8"),
    ("arc1", "1a6449f1"),
...
class P0023DevelopmentBaselineTests(unittest.TestCase):
    ...
    def test_p0023_baseline_is_complete_and_failure_inclusive(self) -> None:
        ...
        self.assertEqual(selected[("arc1", "c8f0f002")], "recolor(from_1=1,from_7=5,from_8=8)")
        self.assertIn("self_mask_macro_stamp", selected[("arc1", "c3e719e8")])
        self.assertEqual(selected[("arc1", "1a6449f1")], "frame_interior_crop")
