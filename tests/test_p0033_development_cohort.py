...
COHORT_PATH = REPOSITORY_ROOT / "research" / "cohorts" / "ARC12_DEVELOPMENT_COHORT_008.json"


class P0033DevelopmentCohortTests(unittest.TestCase):
    def test_p0033_is_disjoint_all_training_filename_only_cohort(self) -> None:
        cohort = json.loads(COHORT_PATH.read_text(encoding="utf-8"))
        development = cohort["development_filename_only_training_40_p0033"]
        import_paths = tuple(
