...
PACKET_PATH = (
    ...
    / "research"
    / "packets"
    / "P0022_ARC12_BILATERAL_SCALE_TRANSFER_50.json"
)
REPORT_ROOT = REPOSITORY_ROOT / "reports" / "P0022_arc12_bilateral_scale_transfer_50"
EXPECTED_SOLVES = {
    ("arc1", "68b16354"),
    ("arc1", "23b5c85d"),
    ("arc2", "31d5ba1a"),
...
class P0022BilateralScaleTransferTests(unittest.TestCase):
    ...
    def test_p0022_is_complete_reproducible_and_retains_limited_transfer(self) -> None:
        ...
        self.assertEqual(packet["implementation_reference"]["exact_solve_count"], 6)
        ...
        self.assertEqual(selected[("arc1", "68b16354")], "top_bottom(scope=all)")
        self.assertEqual(selected[("arc1", "23b5c85d")], "self_contained_subset_crop")
        self.assertIn(
            "adjacent_bilateral_cellwise_combine(axis=horizontal",
            selected[("arc2", "31d5ba1a")],
        )
