...
PACKET_PATH = REPOSITORY_ROOT / "research" / "packets" / "P0030_ARC12_DEVELOPMENT_BASELINE_40.json"
REPORT_ROOT = REPOSITORY_ROOT / "reports" / "P0030_arc12_development_baseline_40"
EXPECTED_SOLVES = {
    ("arc2", "7953d61e"),
    ("arc2", "1b2d62fb"),
}
...
class P0030DevelopmentBaselineTests(unittest.TestCase):
    ...
    def test_p0030_baseline_is_complete_and_failure_inclusive(self) -> None:
        ...
        self.assertEqual(
            {task["split"] for task in tasks if task["benchmark"] == "arc2"},
            {"evaluation", "training"},
        )
        ...
        self.assertIn("dihedral_tile", selected[("arc2", "7953d61e")])
        self.assertIn("central_separator_cellwise_combine", selected[("arc2", "1b2d62fb")])
