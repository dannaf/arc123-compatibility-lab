...
COHORT_PATH = REPOSITORY_ROOT / "research" / "cohorts" / "ARC12_DEVELOPMENT_COHORT_010.json"


class P0039DevelopmentCohortTests(unittest.TestCase):
    def test_p0039_is_disjoint_all_training_filename_only_cohort(self) -> None:
        cohort = json.loads(COHORT_PATH.read_text(encoding="utf-8"))
        development = cohort["development_filename_only_training_40_p0039"]
        import_paths = tuple(
