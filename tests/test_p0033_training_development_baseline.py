...
PACKET_PATH = (
    ...
    / "research"
    / "packets"
    / "P0033_ARC12_TRAINING_DEVELOPMENT_BASELINE_40.json"
)
P0032_REPORT_ROOT = REPOSITORY_ROOT / "reports" / "P0032_arc12_contiguous_component_training_transfer_50"
REPORT_ROOT = REPOSITORY_ROOT / "reports" / "P0033_arc12_training_development_baseline_40"
EXPECTED_SOLVES = {
    ("arc1", "67e8384a"),
    ("arc2", "b1948b0a"),
    ("arc2", "506d28a5"),
...
class P0033TrainingDevelopmentBaselineTests(unittest.TestCase):
    ...
    def test_p0033_retains_complete_development_baseline_artifacts(self) -> None:
        packet = json.loads(PACKET_PATH.read_text(encoding="utf-8"))
        summary = json.loads((REPORT_ROOT / "receipt.json").read_text(encoding="utf-8"))
        p0032_summary = json.loads((P0032_REPORT_ROOT / "receipt.json").read_text(encoding="utf-8"))
        ...
        self.assertEqual(packet["prior_transfer_reference"]["exact_solve_count"], 4)
        self.assertEqual(p0032_summary["exact_solve_count"], 4)
        self.assertEqual(p0032_summary["attempt_count"], 50)
        self.assertTrue(
            all(
                value is False
        ...
        self.assertIn("dihedral_tile", selected[("arc1", "67e8384a")])
        self.assertEqual(selected[("arc2", "b1948b0a")], "recolor(from_6=2,from_7=7)")
        self.assertIn(
            "central_separator_cellwise_combine",
            selected[("arc2", "506d28a5")],
        )
