...
PACKET_PATH = REPOSITORY_ROOT / "research" / "packets" / "P0018_ARC12_DEVELOPMENT_BASELINE_40.json"
REPORT_ROOT = REPOSITORY_ROOT / "reports" / "P0018_arc12_development_baseline_40"
EXPECTED_SOLVES = {
    ("arc1", "d5d6de2d"),
    ("arc1", "c48954c1"),
    ("arc2", "5b6cbef5"),
...
class P0018DevelopmentBaselineTests(unittest.TestCase):
    ...
    def test_p0018_baseline_is_complete_reproducible_and_failure_inclusive(self) -> None:
        ...
        for task in tasks:
            ...
            for test_case in receipt["test_cases"]:
                ...
                self.assertEqual(test_case["all_cells_match"], prediction == expected)
