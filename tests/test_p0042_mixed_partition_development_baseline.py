...
REPORT_ROOT = REPOSITORY_ROOT / "reports" / "P0042_arc12_mixed_partition_development_baseline_40"
EXPECTED_SOLVES = {("arc2", "cf5fd0ad"), ("arc2", "59341089")}
...
class P0042MixedPartitionDevelopmentBaselineTests(unittest.TestCase):
    ...
    def test_p0042_retains_complete_mixed_partition_baseline_artifacts(self) -> None:
        ...
        self.assertEqual(summary["exact_solve_count_by_benchmark"], {"arc1": 0, "arc2": 2})
        ...
        for solve_task_id in ("cf5fd0ad", "59341089"):
            solve_diagram = (
                REPORT_ROOT / "arc2" / solve_task_id / "corpus_callosum.svg"
            ).read_text(encoding="utf-8")
            self.assertIn("dihedral", solve_diagram)
