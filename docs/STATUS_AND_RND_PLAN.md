...
2. P0019 is now exposed development evidence. Preserve P0018's `3/40` baseline and P0019's `5/40` outcome unchanged, then freeze a successor filename-only cohort excluding every prior imported, holdout, and development task ID before inspecting any new task grid.
