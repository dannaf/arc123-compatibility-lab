...
class ActionKind(str, Enum):
    ATTEND = "ATTEND"
    CHOOSE_NEXT_DEMO = "CHOOSE_NEXT_DEMO"
    CHOOSE_NEXT_REGION = "CHOOSE_NEXT_REGION"
    PROPOSE = "PROPOSE"
    ADD_RULE = "ADD_RULE"
    ADD_CONDITION = "ADD_CONDITION"
    REMOVE_CONDITION = "REMOVE_CONDITION"
    BIND_PARAMETER = "BIND_PARAMETER"
    UNBIND_PARAMETER = "UNBIND_PARAMETER"
...
class SolveResult:
    ...
    final_theory: Mapping[str, Any] | None = None
